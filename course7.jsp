...
<ul>
	...
	<p>&nbsp;</p>
			...
			<p>&nbsp;</p>
			<ul>
			<li><p>&nbsp;&nbsp;PHP and MySQL are  excellent choice for webmasters looking to automate their web sites.</p>	
			</li></ul>
