...
<ul>
	...
	<h2><font size=6>ASP.NET</font></h2>
	<p>ASP.NET is a web application framework developed and marketed by Microsoft to allow programmers to build dynamic web sites, web applications and web services. It was first released in January 2002 with version 1.0 of the .NET Framework, and is the successor to Microsoft's Active Server Pages (ASP) technology. ASP.NET is built on the Common Language Runtime (CLR), allowing programmers to write ASP.NET code using any supported .NET language. It is a set of Web development tools offered by Microsoft. ASP.NET is built on the .NET framework, which provides an application program interface (API) for software programmers.</p>
	<p>&nbsp;</p>
			<p>&nbsp;</p>
			...
			<p>&nbsp;</p>
			<ul>
			<li><p>&nbsp;&nbsp;Individuals who  require and intend to build web-based applications using ASP.Net</p>	
			</li></ul>
