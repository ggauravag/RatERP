...
<ul>
	...
	<h2><font size=6>C</font></h2>
	<p> C is a  general-purpose, block structured, procedural, imperative computer programming 
					language for use with the UNIX operating system. It has since spread to many  other
					platforms. Although C was designed as a system implementation language,  it is also
					widely used for applications. C has also greatly influenced many  other popular languages,
					especially C++, which was originally designed as an  extension to C.</p>
	<p>&nbsp;</p>
			<p>&nbsp;</p>
			<h3>Duration: 30 Days</h3>
			...
			<p>&nbsp;</p>
			<ul>
			<li><p>&nbsp;&nbsp;This course is valuable for developers and  engineers interested in programming using C#. Knowledge and/or experience of  VB, C/C++ or Java, is a must.</p>	
			</li></ul>
...
<div id="panel">
		...
		<div id="contact-area">
			...
			<form name="Form1" method="post" onsubmit="" action="">
				...
				<input type="hidden" value="9" name="course">
