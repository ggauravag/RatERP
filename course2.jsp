...
<ul>
	...
	<h2><font size=6>Java Frameworks</font></h2>
	<p>Java view technologies and frameworks are web-based software libraries that provide the user interface, or "view-layer", of Java web applications. Such application frameworks are used for defining web pages and handling the HTTP requests (clicks) generated by those web pages. As a sub-category of web application frameworks, view-layer frameworks often overlap to varying degrees with web frameworks that provide other functionality for Java web applications.

Java view-layer frameworks often claim to support some or all of the Model - view - controller design pattern.</p>
	<p>&nbsp;</p>
			<p>&nbsp;</p>
			...
			<p>&nbsp;</p>
			<ul>
			<li><p>&nbsp;&nbsp;Any one who has prior knowledge of Java SE and Java EE and aims to be an expert in JAVA.</p>	
			</li></ul>
