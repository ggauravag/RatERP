...
try
{
	...
	if( payee != null )
	{
		...
		{
			ps2 = con.prepareStatement("update student set deposit_fee=? where studentid=?");
			ps2.setInt(1, (amt));
			ps2.setString(2, stu.getSid());
			int j = ps2.executeUpdate();
			ps2.close();
	...
	else if( inst!= null )
	{
		...
		{
			ps1 = con.prepareStatement("update student set deposit_fee=? where studentid=?");
			ps1.setInt(1, (amt));
			ps1.setString(2, stu.getSid());
			int j = ps1.executeUpdate();
			ps1.close();
	...
	SendMail.sendWelcome(stu,basePath,(String)session.getAttribute("pwd"));
%>
 ...
 <legend><table><tr><td><img src="../css/images/rat.png" height="100"></img></td><td align="right"><strong><h1>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Road Ahead Technologies</h1></strong></td></tr></table></legend>
  	 ...
  	 <table width="1000px" align="center">
  	 	...
  	 	<%
  	 			...
  	 			//double dd2dec = new Double(df2.format(stu.getPackageFees())).doubleValue();
  	 			%>
  	 			
  	 			<tr>
  	 				<td><%=stu.getPackageName() %></td>
  	 				<td>Rs. <%=stu.getPackageFees()%></td>
  	 			</tr>
  	 			...
  	 			<tr>
  	 				...
  	 				<td>Rs. <%=(amt - stu.getPackageFees()) %></td>
