...
<ul>
	...
	<h2><font size=6>Oracle 10g</font></h2>
	<p>Oracle Database 10g  is Oracle&rsquo;s revolutionary new grid offering for database administrators, which  include breakthrough self-management, storage management, and clustering  features. It is designed to relieve system administrators from repetitive,  low-value administrative work and provide them with an opportunity to increase  their value and expand their technical skills. The new Oracle University  curriculum tracks for Oracle Database 10g are tailored to the scale and needs  of customers&rsquo; data centers. These new courses target current and new Oracle  Database Administrators and provide training in half the time and half the  cost.

Oracle Database 10g offers many new tools that help DBAs work more efficiently, freeing them for more strategic, creative endeavors?not to mention their nights and weekends.</p>
	<p>&nbsp;</p>
			<p>&nbsp;</p>
			...
			<p>&nbsp;</p>
			<ul>
			<li><p>&nbsp;&nbsp;This course is  valuable for those who are, or will be, working with Oracle9i. Experience with  relational databases and familiarity with basic programming concepts are  helpful. Computer Fundamentals and Windows Operating System knowledge is an  advantage. Any Programing Langauge, DBMS like Dbase or FoxPro are preferred.</p>	
			</li></ul>
...
<div id="panel">
		...
		<div id="contact-area">
			...
			<form name="Form1" method="post" onsubmit="" action="">
				...
				<input type="hidden" name = "course" value="100">
