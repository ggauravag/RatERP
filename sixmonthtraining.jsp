...
<head>
	<title>Six Month Training </title>
...
<ul>
	...
	<!-- END Header -->
		...
		<div id="main">
			...
			<div class="large-col">
					...
					<h2><font size=6>6 Months Training</font></h2>
            ...
            <tr>
              ...
              <td width="127" align="center" class="paratext"><div align="center"><strong>Duration</strong></div></td>
              </tr>

            <tr>
              <td width="129" class="paratext"><div align="center">MCA/MSC-IT</div></td>
              <td width="127" class="paratext"><div align="center">6 Months </div></td>
              </tr>
          </table></p>
  ...
  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; d. Two Passport size photographs. </p>
          <p class="paratext">4. After joining,  period  assigned to them for study and doubt clearing sessions is known as &ldquo;study  period&rdquo;.</p>
  ...
  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; b. 40% on the basis of projects and  presentation.</p>
          <p class="paratext">7. After completion of training, trainee has  to submit the project in both hard <br />
  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; copy and soft copy.</p>
